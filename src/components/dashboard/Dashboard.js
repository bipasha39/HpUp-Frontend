...
export default function Dashboard(props) {
  ...
  return (
    <Box display="flex" flexDirection="column" flex="1" bg="white">
      <Box p="10" display="flex" flexDirection="row">
        <Box flex="2">
          <InputGroup border="5%" borderColor="#1e3248">
            <InputLeftElement
              bg="#192A3E"
              pointerEvents="none"
      ...
      <Box ml="8">
        <Menu >
          <MenuButton bg="#192A3E" color="white" as={Button} rightIcon={<ChevronDownIcon />}>
            Company
          </MenuButton>
          <MenuList>
